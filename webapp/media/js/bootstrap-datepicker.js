...
!function($) {
	...
	Datepicker.prototype = {
		...
		_trigger : function(event, altdate) {
			var date = altdate || this.date, local_date = new Date(date
					.getTime()
		...
		this
				.each(function() {
					...
					if (!data) {
						...
						// Preliminary otions
						xopts = $.extend({}, $.fn.datepicker.defaults, elopts,
								options), locopts = opts_from_locale(xopts.language),
						// Options priority: js args, data-attrs, locales,
						// defaults
						opts = $.extend({}, $.fn.datepicker.defaults, locopts,
								elopts, options);
