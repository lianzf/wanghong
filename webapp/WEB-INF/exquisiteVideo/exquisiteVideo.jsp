...
<body class="page-header-fixed page-footer-fixed">
	...
	<script>
		...
		function initPage(){
			var oTable = $('#portlet_Tables').dataTable({
		        ...
		        "fnServerParams" : function(aoData) {
					aoData.push({"name" : "columnId","value" : "${C_VIDEO_RECOMMEND}"});
				},
				"sServerMethod" : "POST",
				"sAjaxSource" : "getList",
				"aoColumns" : [{
					...
					"mRender" : function(obj){
						if(obj != null){
							return '<img src="../downloadFile.jsp?identity=${videoBaseIcon}&path='+obj+'" width="38" height="54" />';
						}else{
							return "";
						}
					}
					...
					"fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
						var html = '<a class="btn mini purple" onclick="edit('+oData.id+','+oData.columnId+','+oData.videoColumnId+')"><i class="icon-edit"></i> 编辑</a>';
		...
		function edit(id,columnId,videoColumnId){
			App.Modal.load("./add",{'id' : id,'columnId' : columnId,'videoColumnId' : videoColumnId},{"title":"选择视频"});
		}
	</script>
</body>
<!-- END BODY -->
