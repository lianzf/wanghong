...
function initPageColumnActor(){
	...
	var oTable = $('#portlet2_Tables').dataTable({
		...
		"sServerMethod" : "POST",
		"sAjaxSource" : "./getActorRecommendList",
		"aoColumns" : [ {
			"sClass" : "center",
			"mDataProp" : "id"
		}, {
			...
			"fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
				var click = "addActor("+oData.id+",'${columnId}','${actorColumnId}')";
...
function addActor(id,columnId,actorColumnId){
	$.ajax({
		type : 'POST',
