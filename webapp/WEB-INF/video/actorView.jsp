...
function initPageColumnActor(){
	...
	var oTable = $('#portlet2_Tables').dataTable({
		...
		"sServerMethod" : "POST",
		"sAjaxSource" : "../exquisiteActor/getActorRecommendList",
		"aoColumns" : [ {
			"sClass" : "center",
			"mDataProp" : "id"
		}, {
			...
			"fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
				var html = "<a class='btn mini green' onclick=sureActor("+oData.id+")><i class='icon-check'></i> 选择</a>"
