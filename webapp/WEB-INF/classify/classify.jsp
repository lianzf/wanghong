...
<body class="page-header-fixed page-footer-fixed">
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li><i class="icon-list"></i><a href="＃">分类区域</a><i class="icon-angle-right"></i></li>
							<li><a href="#">列表</a></li>
						</ul>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<span>列表排列顺序优先级<i class="icon-sort-by-order-alt"></i></span>
	...
	<script>
		...
		function edit(id){
			App.Modal.load("./add",{'id' : id},{"title":"修改ICON"});
		}
	</script>
</body>
<!-- END BODY -->
