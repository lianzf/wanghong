...
<body class="page-header-fixed page-footer-fixed">
		...
		<div class="page-content">
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						<ul class="breadcrumb">
							<li><i class="icon-list"></i><a href="＃">播单库</a><i class="icon-angle-right"></i></li>
							<li><a href="#">列表</a></li>
						</ul>
					</div>
				</div>
								...
								<div id="sample_2_wrapper" class="dataTables_wrapper form-inline" role="grid">
									<div class="row-fluid">
										<div class="control-group">
											<a id="add" class="btn green" ><i class="icon-plus"></i> 添加播单</a>
										</div>
									</div>
									<div class="row-fluid">
	...
	<script>
				...
				"aoColumns" : [{
					...
					"fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
						...
						if(oData.state == 0 || oData.state == null){
							html += " <a class='btn mini red' href='javascript:;' onclick=confirm('"+oData.id+"',"+oData.state+",'您确认要发布该播单吗?')><i class='icon-ok'></i> 启用</a>";
						}else{
							html += " <a class='btn mini green' href='javascript:;' onclick=confirm('"+oData.id+"',"+oData.state+",'您确认要停用该播单吗?')><i class='icon-remove'></i> 停用</a>";
						}
						html += '<a class="btn mini purple" onclick="addVideo('+oData.id+')"><i class="icon-plus"></i> 添加视频</a>';
						return $(nTd).html(html);	
					}
				} ],
		...
		function edit(id){
			App.Modal.load("./add",{'id' : id},{"title":"修改播单"});
		}
