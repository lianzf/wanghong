		...
		<div class="portlet-body form row-fluid">
			<form id="form_sample_2" action="#" class="form-horizontal dialog">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="actorId" readonly class="m-wrap span10" value="${actorId}">
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" for="firstName">主播昵称</label>
					<div class="controls">
						<input type="text" readonly class="m-wrap span10" value="${nickname}">
					</div>
				</div>
				<div class="control-group">
