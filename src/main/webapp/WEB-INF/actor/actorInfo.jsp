									...
									<div class="span3">
										...
										<ul class="ver-inline-menu tabbable margin-bottom-10">
											...
											<li class="active"><a data-toggle="tab" href="#tab_1-1">
													...
													<i class="icon-cog"></i> Personal info
												...
												<div style="height: auto;" id="accordion1-1"
													...
													<form action="#">
														...
														<label class="control-label">First Name</label> <input
															type="text" placeholder="John" class="m-wrap span8" /> <label
															class="control-label">Last Name</label> <input
															type="text" placeholder="Doe" class="m-wrap span8" /> <label
															class="control-label">Mobile Number</label> <input
