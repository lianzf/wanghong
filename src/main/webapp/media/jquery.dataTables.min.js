...
(function(Ea, P, k) {
    var O = function(h) {
        ...
        function Ha(a) {
            ...
            d, f, g, i, j, h, l, q, o;
            d = 0;
            for (f = b.length; d < f; d++) if (l = b[d], o = [], !l.sType && l._sManualType) l.sType = l._sManualType;
            else if (!l.sType) {
                g = 0;
        ...
        function y(a, b, c, e) {
            ...
            if (c === k) return a.iDrawError != d && null === i && (R(a, 0, "Requested unknown parameter " + ("function" == typeof f.mData ? "{function}": "'" + f.mData + "'") + " for row " + b, 4), a.iDrawError = d),
            i;
        ...
        function na(a, b, c, e) {
            ...
            a = function(a) {
                ...
                g && g._bAttrSrc ? (Q(g.mData._)(e, j), q(g.mData.sort, a), q(g.mData.type, a), q(g.mData.filter, a)) : l ? (g._setter || (g._setter = Q(g.mData)), g._setter(e, j)) : e[i] = j;
                i++
            };
            if (f) for (; f;) {
        ...
        function ea(a, b, c) {
            ...
            if (b) {
                ...
                for (d = g.length; e < d; e++) {
                    ...
                    f = 0;
                    for (b = g[e].length; f < b; f++) if (n = j = 1, i[e][f] === k) {
                        a.appendChild(g[e][f].cell);
                        for (i[e][f] = 1; g[e + j] !== k && g[e][f].cell == g[e + j][f].cell;) i[e + j][f] = 1,
                        j++;
        ...
        function tb(a) {
            ...
            o("mDataProp_" + g, j),
            e.bFilter && (o("sSearch_" + g, l.sSearch), o("bRegex_" + g, l.bRegex), o("bSearchable_" + g, n.bSearchable)),
        ...
        function ob(a) {
            ...
            j = h("input", b).val(d.sSearch).attr("placeholder", e.sSearchPlaceholder).bind("keyup.DT search.DT input.DT paste.DT cut.DT", g ? ua(f, g) : f).bind("keypress.DT",
            function(a) {
        ...
        function xb(a) {
            ...
            e, d, f = 0,
            g = b.length; f < g; f++) {
                for (var i = [], j = 0, h = c.length; j < h; j++) d = c[j],
                e = a.aoData[d],
        ...
        function Y(a) {
            ...
            if (r.outerWidth() < g) {
                ...
                if (w && (j.scrollHeight > j.offsetHeight || "scroll" == q.css("overflow-y"))) u.width = s(v - f); ("" === c || "" !== e) && R(a, 1, "Possible column misalignment", 6)
            } else v = "100%";
            o.width = s(v);
            i.width = s(v);
            K && (a.nScrollFoot.style.width = s(v)); ! d && w && (o.height = s(t.offsetHeight + f));
        ...
        function G(a, b, c) {
            ...
            g, i; d < f;) {
                g = b[d].firstChild;
                for (i = c ? c[d].firstChild: null; g;) 1 === g.nodeType && (c ? a(g, i, e) : a(g, e), e++),
                g = g.nextSibling,
        ...
        function Ga(a) {
            ...
            k = !1,
            o,
            m; (o = b.style.width) && -1 !== o.indexOf("%") && (n = o);
            for (o = 0; o < e.length; o++) m = c[e[o]],
            null !== m.sWidth && (m.sWidth = Db(m.sWidthOrig, l), k = !0);
            if (!k && !f && !d && i == aa(a) && i == j.length) for (o = 0; o < i; o++) c[o].sWidth = s(j.eq(o).width());
            else {
                ...
                for (o = 0; o < e.length; o++) m = c[e[o]],
                j[o].style.width = null !== m.sWidthOrig && "" !== m.sWidthOrig ? s(m.sWidthOrig) : "";
                if (a.aoData.length) for (o = 0; o < e.length; o++) k = e[o],
                m = c[k],
                ...
                if (f) {
                    ...
                    d = h(j[o]).outerWidth(),
                    g += null === m.sWidthOrig ? d: parseInt(m.sWidth, 10) + d - h(j[o]).width();
                    i.width(s(g));
                    b.style.width = s(g)
                }
        ...
        function Ib(a, b) {
            ...
            for (var f, g = m.ext.type.order[c.sType + "-pre"], h = 0, j = a.aoData.length; h < j; h++) if (c = a.aoData[h], c._aSortData || (c._aSortData = []), !c._aSortData[b] || e) f = e ? d[h] : y(a, h, b, "sort"),
            ...
            iterator: function(a, b, c, e) {
                ...
                for (h = l.length; g < h; g++) {
                    ...
                    f !== k && d.push(f);
                        ...
                        f = "cell" === b ? c.call(p, l[g], f.row, f.column, g, j) : c.call(p, l[g], f, g, j, q),
                        f !== k && d.push(f)
                    }
                }
        ...
        t.register = r = function(a, b) {
            ...
            else for (var d = a.split("."), f = Tb, g, i, c = 0, e = d.length; c < e; c++) {
        ...
        Ca = function(a, b) {
            ...
            } else if ("current" == e || "applied" == e) f = "none" == i ? c.slice() : "applied" == i ? g.slice() : h.map(c,
            function(a) {
                return - 1 === h.inArray(a, g) ? a: null
            });
            else if ("index" == e || "original" == e) {
                c = 0;
                for (e = a.aoData.length; c < e; c++)"none" == i ? f.push(c) : (d = h.inArray(c, g), ( - 1 === d && "removed" == i || 0 <= d && "applied" == i) && f.push(c))
            }
            return f
        };
        r("rows()",
        ...
        function(a) {
            ...
            function(b) {
                ...
                f.children().detach();
                f.append(l);
                j.css("width", b.sDestroyWidth).removeClass(e.sTable); (q = b.asDestroyStripes.length) && f.children().each(function(a) {
